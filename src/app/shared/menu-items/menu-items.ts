...
const MENUITEMS = [
    ...
    {
        state: '/product/product_list',
        name: 'Products',
        type: 'link',
        icon: 'all_out',
    },
    {
        state: '/customer/reg_cutomer',
        name: 'Customers',
        type: 'link',
        icon: 'group',
    },
    {
        state: '/inventory/all_inventory',
        name: 'Inventory',
        type: 'link',
        icon: 'inventory',
    },
    {
        state: '/order/all_orders',
        name: 'Orders',
        type: 'link',
        icon: 'local_mall',
    },
    {
        state: '/sales/sales_detail',
        name: 'Sales',
        type: 'link',
        icon: 'sell',
    },
    {
        state: '/delivery/delivery_detail',
        name: 'Delivery',
        type: 'link',
        icon: 'airport_shuttle',
    },
    {
        state: '/vendor/vendors_list',
        name: 'Vendor',
        type: 'link',
        icon: 'store',
    },
