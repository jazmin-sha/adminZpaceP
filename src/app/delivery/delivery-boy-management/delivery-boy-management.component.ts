...
export class DeliveryBoyManagementComponent implements OnInit,  AfterViewInit {


  @ViewChild(MatTable, { static: true }) table: MatTable<any> = Object.create(null);
  searchText: any;
  displayedColumns: string[] = ['#', 'Delivery Boy Name','Delivery Boy Email', 'Delivery Status', 'Payment','Petrol Request',  'action'];
